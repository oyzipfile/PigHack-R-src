...
public class AutoCrystal extends Module
{
    ...
    public AutoCrystal() {
        ...
        this.placeDelay = (Setting<Float>)this.register(new Setting("PlaceDelay", 4.0f, 0.0f, 300.0f));
        this.placeRange = (Setting<Float>)this.register(new Setting("PlaceRange", 4.0f, 0.1f, 7.0f));
        this.explode = (Setting<Boolean>)this.register(new Setting("Break", true));
        this.packetBreak = (Setting<Boolean>)this.register(new Setting("PacketBreak", true));
        this.attackFactor = (Setting<Integer>)this.register(new Setting("PredictDelay", 0, 0, 200));
        this.predicts = (Setting<Boolean>)this.register(new Setting("Predict", true));
        this.rotate = (Setting<Boolean>)this.register(new Setting("Rotate", true));
        this.breakDelay = (Setting<Float>)this.register(new Setting("BreakDelay", 4.0f, 0.0f, 300.0f));
        this.breakRange = (Setting<Float>)this.register(new Setting("BreakRange", 4.0f, 0.1f, 7.0f));
        this.breakWallRange = (Setting<Float>)this.register(new Setting("BreakWallRange", 4.0f, 0.1f, 7.0f));
        this.opPlace = (Setting<Boolean>)this.register(new Setting("1.13 Place", true));
        this.suicide = (Setting<Boolean>)this.register(new Setting("AntiSuicide", true));
        this.autoswitch = (Setting<Boolean>)this.register(new Setting("AutoSwitch", true));
        this.ignoreUseAmount = (Setting<Boolean>)this.register(new Setting("IgnoreUseAmount", true));
        this.wasteAmount = (Setting<Integer>)this.register(new Setting("UseAmount", 4, 1, 5));
        this.facePlaceSword = (Setting<Boolean>)this.register(new Setting("FacePlaceSword", true));
        this.targetRange = (Setting<Float>)this.register(new Setting("TargetRange", 4.0f, 1.0f, 12.0f));
        this.minDamage = (Setting<Float>)this.register(new Setting("MinDamage", 4.0f, 0.1f, 20.0f));
        this.facePlace = (Setting<Float>)this.register(new Setting("FacePlaceHP", 4.0f, 0.0f, 36.0f));
        this.breakMaxSelfDamage = (Setting<Float>)this.register(new Setting("BreakMaxSelf", 4.0f, 0.1f, 12.0f));
        this.breakMinDmg = (Setting<Float>)this.register(new Setting("BreakMinDmg", 4.0f, 0.1f, 7.0f));
        this.minArmor = (Setting<Float>)this.register(new Setting("MinArmor", 4.0f, 0.1f, 80.0f));
        this.swingMode = (Setting<SwingMode>)this.register(new Setting("Swing", SwingMode.MainHand));
        this.render = (Setting<Boolean>)this.register(new Setting("Render", true));
        this.renderDmg = (Setting<Boolean>)this.register(new Setting("RenderDmg", true));
