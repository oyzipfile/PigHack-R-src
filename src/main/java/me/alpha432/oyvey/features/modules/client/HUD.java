...
public class HUD extends Module
{
    ...
    private Setting<Boolean> arrayList = null;
    ...
    public HUD() {
        ...
        this.command = (Setting<String>)this.register(new Setting<>("Command", "OyVey"));
        ...
        this.animationHorizontalTime = register(new Setting("AnimationHTime", 500, 1, 1000, v -> arrayList.getValue()));
        this.animationVerticalTime = (Setting<Integer>)this.register(new Setting("AnimationVTime", 50, 1, 500, v -> arrayList.getValue()));
        ...
        this.arrayList = (Setting<Boolean>)register(new Setting<>("ActiveModules", false, "Lists the active modules."));
